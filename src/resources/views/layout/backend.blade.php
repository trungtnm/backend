...
<head>
    ...
    <script type="text/javascript">
        ...
        var CkOptions = {
            filebrowserImageBrowseUrl: '/{{config('lfm.prefix')}}?type=Images',
            filebrowserImageUploadUrl: '/{{config('lfm.prefix')}}/upload?type=Images&_token=' + csrfToken,
            filebrowserBrowseUrl: '/{{config('lfm.prefix')}}?type=Files',
            filebrowserUploadUrl: '/{{config('lfm.prefix')}}/upload?type=Files&_token=' + csrfToken
        };
    </script>
</head>
<body class="no-skin">
...
<script type="text/javascript"
        src="{{ asset('vendor/trungtnm/backend/js/datepicker/bootstrap-datepicker.js') }}"></script>
<script type="text/javascript"
        src="{{ asset('bower/x-editable/dist/bootstrap3-editable/js/bootstrap-editable.min.js') }}"></script>
</body>
</html>
